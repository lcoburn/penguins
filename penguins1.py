...
def animate(t, n, r, L, noise, dt, v0, a, f, tt, k, tau, s, tau1, R, F, S):
    global pos 
...
#for t in range(10):
    #animate(t, n, r, L, noise, dt, v0, a, f, tt, k, tau, s, tau1, R, F, S)
    
#class matplotlib.animation.FuncAnimation(fig, func, frames=None, init_func=None, fargs=None, save_count=None, **kwargs)
anim = animation.FuncAnimation(fig, animate, fargs=(n, r, L, noise, dt, v0, a, f, tt, k, tau, s, tau1, R, F, S))
plt.show()
